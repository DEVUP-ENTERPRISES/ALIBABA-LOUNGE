            ...
            {resetMode ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-6 font-[family-name:var(--font-body)] text-sm text-white/40 hover:text-white/70 transition-colors"
                >
                  ← Back to sign in
                </button>
              </motion.div>
              ...
              >
                ...
                <form onSubmit={handleEmail} className="space-y-4">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="font-[family-name:var(--font-body)] text-xs text-white/40 hover:text-[#d4af37] transition-colors"
                    >
                      Forgot password?
                    </button>
                  </div>
                ...
                <p className="mt-8 text-center font-[family-name:var(--font-body)] text-sm text-white/40">
                  Don&apos;t have an account?{" "}
                  <Link
                    href="/signup"
                    className="text-[#d4af37] hover:text-[#f0cc58] transition-colors"
                  >
                    Create one
                  </Link>
                </p>
...
function Spinner({ dark }: { dark?: boolean }) {
  return (
    <svg
      className={`h-4 w-4 animate-spin ${dark ? "text-[#050505]" : "text-white/60"}`}
