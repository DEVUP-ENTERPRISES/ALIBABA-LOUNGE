...
const defaultSettings: AdminSetting = {
  ...
  description: "Dallas's premier hookah lounge & dining destination. Where luxury meets flavor.",
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-14 sm:pt-20 pb-8">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="font-[family-name:var(--font-accent)] text-[9px] tracking-[0.15em] text-white/35 uppercase">Sun – Thu</p>
                  <p className="mt-0.5 font-[family-name:var(--font-body)] text-sm text-white/55">{settings.hoursSunThu}</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                <Clock className="size-4 text-[#d4af37]/50 shrink-0 mt-0.5" />
                <div>
                  <p className="font-[family-name:var(--font-accent)] text-[9px] tracking-[0.15em] text-white/35 uppercase">Fri – Sat</p>
                  <p className="mt-0.5 font-[family-name:var(--font-body)] text-sm text-white/55">{settings.hoursFriSat}</p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-14 sm:mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-8 sm:flex-row">
          ...
          <p className="font-[family-name:var(--font-accent)] text-[10px] tracking-[0.28em] text-white/25 uppercase text-center">
            Designed with passion in {settings.location}
          </p>
        </div>
      </div>
    </footer>
