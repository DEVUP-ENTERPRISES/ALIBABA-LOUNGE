...
const settingSchema = new mongoose.Schema(
  {
    ...
    phone: { type: String, default: "+1 (214) 407-7941", trim: true },
    location: { type: String, default: "Dallas, TX", trim: true },
    email: { type: String, default: "info@alibabahookahlounge.com", trim: true },
    ...
    hoursSunThu: { type: String, default: "11 AM – 2 AM", trim: true },
    hoursFriSat: { type: String, default: "11 AM – 3 AM", trim: true },
